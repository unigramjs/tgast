...
export type { BlockContent, BlockContentMap } from './registries/block-content.ts'
export type { InlineEntity, InlineEntityMap } from './registries/inline-entity.ts'
export type { RootContent, RootContentMap } from './registries/root-content.ts'
export type { StyleEntity, StyleEntityMap } from './registries/style-content.ts'
